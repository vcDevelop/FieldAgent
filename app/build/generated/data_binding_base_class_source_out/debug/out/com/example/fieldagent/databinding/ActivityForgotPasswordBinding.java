...
public final class ActivityForgotPasswordBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText EmailForgot;
  ...
  private ActivityForgotPasswordBinding(@NonNull ConstraintLayout rootView,
      @NonNull EditText EmailForgot, @NonNull Button ForgotButton, @NonNull ImageView imageView2,
  ...
  public static ActivityForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.EmailForgot;
      EditText EmailForgot = ViewBindings.findChildViewById(rootView, id);
      if (EmailForgot == null) {
        break missingId;
      }
      ...
      return new ActivityForgotPasswordBinding((ConstraintLayout) rootView, EmailForgot,
          ForgotButton, imageView2, textView3);
    }
