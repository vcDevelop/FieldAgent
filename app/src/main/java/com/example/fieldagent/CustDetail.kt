...
//            findViewById<TextView>(R.id.OccupiedSince).text = client.occupied_by
//
...
//            findViewById<TextView>(R.id.SiteInspectionDate).text = client.site_inspection_date
...
//            findViewById<TextView>(R.id.widthofroad).text = client.width_of_road
            ...
            // Add more TextViews or UI components to display other data
        }
    }
}
